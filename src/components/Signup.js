 ...
 class Signup extends Component {
    ...
    handleSubmit = (e) => {
	 ...
	 addUserAsPromise = (addUser, data) => {
		this.mutateData(addUser,{name:data.name,email:data.email,password:data.password,cellNumber:data.cellNumber,roles:data.roles})  // return a promise
		.then(result=>{
                        ...
                        <div className="col-md-6 offset-md-2">
							...
							<div className="row">
								<div className="col-md-12">
									<img src={logo} width="2.1%" alt="" /> <code>Registration.</code>
								</div>
							</div>
						</div>
