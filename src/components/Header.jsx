  ...
  onLogoutClick () {
    ...
    // } else {
      return (
		  ...
		  <div>
		  <li className='nav-item list-inline-item'>
		  <Link to='/dashboard' className='nav-link' replace> Dashboard
		  </Link>
		</li>
          <li className='nav-item list-inline-item'>
            <Link to='/signup' className='nav-link' replace> Signup
            </Link>
          </li>
          <li className='nav-item list-inline-item'>
            <Link to='/login' className='nav-link' replace> Login
            </Link>
          </li>
        </div>
      ...
      <nav className='navbar navbar-expand-lg navbar-dark bg-dark fixed-top' id='landingNav'>
        ...
        <img
          ...
          width='30'
					height='30'
					alt=""
          className='d-inline-block align-top' /> Intelligent Monitor
        </Link>
        <button
