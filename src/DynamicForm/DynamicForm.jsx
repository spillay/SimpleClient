...
import {
    required, isSDP, isDRP, isSlider, isString, isCurrency,
                    ...
                    row.map((m, idx) => {
                        ...
                        if (type === "text" || "email" || "password" || "number") {
                            ...
                            if (valData !== ""){
                                ...
                                input = <TextView _key={key} label={label} value={valData} type={type} stage={this.state.stage} errorFor={this.errorFor} onChange={this.onChange} options={options} />
                            } else {
                                input = <TextView _key={key} label={label} value="" type={type} stage={this.state.stage} errorFor={this.errorFor} onChange={this.onChange} options={options} />
                            }
                        }
