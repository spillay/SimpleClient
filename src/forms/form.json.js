export const loginForm = [
  ...
  export const signupForm = [ 
    {
      key: 'roles', label: 'Role', type: 'checkbox', fieldValidations: { required: true }, opts: { inline: true }, options: [
        { key: '5b3ff4637cae2a3814478c9f', label: 'Administrator', value: 'Administrator' },
        { key: '5b3ff4757cae2a3814478ca0', label: 'Capturer', value: 'Capturer' },
        { key: '5b3ff4837cae2a3814478ca2', label: 'Manager', value: 'Manager' },
		    { key: '5b3ff47c7cae2a3814478ca1', label: 'SuperUser', value: 'SuperUser' },
        { key: '5b3ff48d7cae2a3814478ca3', label: 'Resolver', value: 'Resolver' },
        { key: '5b3ff4997cae2a3814478ca4', label: 'QA', value: 'QA' }
		
      ]
    },
    { key: 'name', label: 'First Name', type: 'text', fieldValidations: { required: true, isString: true, minLength: 5, maxLength: 30 }, options: { autoComplete: 'given-name', placeholder: 'First Name...', icon: 'fa fa fa-user' } },
    { key: 'email', label: 'User Name (email address)', type: 'email', fieldValidations: { required: true, emailFormat: true }, options: { autoComplete: 'email', placeholder: 'Email address...', icon: 'fa fa fa-envelope-o' } },
    ...
    { key: 'cellNumber', label: 'Phone Mobile', type: 'text', fieldValidations: { required: true, isCellnumber: true }, options: { autoComplete: 'tel', placeholder: 'Phone Mobile...', icon: 'fa fa fa-phone' } },
  ...
  export const changePasswordForm = [
    { key: 'password', label: 'Current Password', type: 'password', fieldValidations: { required: true, minLength: 6 }, options: { autoComplete: 'current-password', placeholder: 'Password..', icon: 'fa fa fa-lock' } },
    { key: 'newpassword', label: 'New Password', type: 'password', fieldValidations: { required: true, minLength: 6 }, options: { autoComplete: 'current-password', placeholder: 'Password..', icon: 'fa fa fa-lock' } },
